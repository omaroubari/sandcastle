...
| **Home dir**         | The home directory inside the **sandbox**, declared on the **sandbox provider** at construction time via `homeDir`. Used for tilde expansion in `sandboxPath` mounts. Providers without a meaningful home directory return `undefined` | "sandboxHomedir", "sandbox home", "container home"                            |
